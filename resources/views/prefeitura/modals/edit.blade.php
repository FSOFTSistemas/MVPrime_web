...
<div class="modal fade" id="editPrefeituraModal{{ $prefeitura['id'] }}" tabindex="-1" role="dialog"
    aria-labelledby="editPrefeituraModalLabel" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <select class="form-control select2" name="endereco_id" required>
                            @foreach ($enderecos as $endereco)
                                <option value="{{ $endereco['id'] }}"
                                    {{ $prefeitura['endereco_id'] == $endereco['id'] ? 'selected' : '' }}>
